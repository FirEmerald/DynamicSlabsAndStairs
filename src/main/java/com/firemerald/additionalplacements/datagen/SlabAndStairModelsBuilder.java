...
public class SlabAndStairModelsBuilder
{
	...
	*/
	...
	@SuppressWarnings("unchecked")
	public SlabAndStairModelsBuilder setStairs(StairsBlock block, String folder, String parentMod, String parentFolder)
	{
	...
	public SlabAndStairModelsBuilder setStairs(StairsBlock block, String folder)
	{
		return setStairs(block, folder, null, null);
	}
