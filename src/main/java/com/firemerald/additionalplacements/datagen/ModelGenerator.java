...
public class ModelGenerator extends BlockStateProvider
{
	...
	protected void registerStatesAndModels()
	{
		...
		*/
		...
		.setSlab(SlabAndStairModelsBuilder.SLAB_DYNAMIC).addAction((builder, model) -> builder.customLoader(DynamicModelLoaderBuilder::new).setModel(ResourceLocation.tryBuild(AdditionalPlacementsMod.MOD_ID, SlabAndStairModelsBuilder.SLAB_BASE + model))).compile() //build dynamic slab
		.setStairs(SlabAndStairModelsBuilder.STAIRS_DYNAMIC).addAction((builder, model) -> builder.customLoader(DynamicModelLoaderBuilder::new).setModel(ResourceLocation.tryBuild(AdditionalPlacementsMod.MOD_ID, SlabAndStairModelsBuilder.STAIRS_BASE + model))).compile(); //build dynamic stairs
		...
		.setCarpet(CarpetModelsBuilder.CARPET_DYNAMIC).addAction((builder, model) -> builder.customLoader(DynamicModelLoaderBuilder::new).setModel(ResourceLocation.tryBuild(AdditionalPlacementsMod.MOD_ID, CarpetModelsBuilder.CARPET_BASE + model))).compile(); //build dynamic carpet
		...
		.setPressurePlate(PressurePlateModelsBuilder.PRESSURE_PLATE_DYNAMIC).addAction((builder, model) -> builder.customLoader(DynamicModelLoaderBuilder::new).setModel(ResourceLocation.tryBuild(AdditionalPlacementsMod.MOD_ID, PressurePlateModelsBuilder.PRESSURE_PLATE_BASE + model))).compile(); //build dynamic pressure plate
	}
}