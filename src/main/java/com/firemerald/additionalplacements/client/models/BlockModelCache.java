...
public class BlockModelCache {
	...
	public static BakedModel bake(UnbakedModel model, ModelBakery baker, Function<Material, TextureAtlasSprite> spriteGetter, ModelState modelTransform, ResourceLocation modelLocation) {
	...
	public static BakedModel bake(UnbakedModel model, ModelBakery baker, Function<Material, TextureAtlasSprite> spriteGetter, ResourceLocation modelLocation) {
