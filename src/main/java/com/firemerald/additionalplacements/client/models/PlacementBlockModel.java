...
public class PlacementBlockModel
{
	...
	private static BakedModel bake(UnbakedModel model, ModelBakery baker, Function<Material, TextureAtlasSprite> spriteGetter, ModelState modelTransform, ResourceLocation modelLocation) {
	...
	private static BakedModel bake(UnbakedModel model, ModelBakery baker, Function<Material, TextureAtlasSprite> spriteGetter, ResourceLocation modelLocation) {
