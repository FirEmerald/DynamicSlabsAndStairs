...
public class VoxelShapes
{
	...
	//52
	STAIRS_TWIST_CLOCKWISE_UP_SOUTH = Shapes.or(PILLAR_EAST_DOWN, PILLAR_WEST_NORTH),
	STAIRS_TWIST_COUNTER_CLOCKWISE_UP_SOUTH = Shapes.or(PILLAR_WEST_DOWN, PILLAR_EAST_NORTH),
	STAIRS_TWIST_CLOCKWISE_UP_NORTH = Shapes.or(PILLAR_WEST_DOWN, PILLAR_EAST_SOUTH),
	STAIRS_TWIST_COUNTER_CLOCKWISE_UP_NORTH = Shapes.or(PILLAR_EAST_DOWN, PILLAR_WEST_SOUTH),
	...
	//60
	STAIRS_TWIST_CLOCKWISE_UP_EAST = Shapes.or(PILLAR_DOWN_NORTH, PILLAR_WEST_SOUTH),
	STAIRS_TWIST_COUNTER_CLOCKWISE_UP_EAST = Shapes.or(PILLAR_DOWN_SOUTH, PILLAR_WEST_NORTH),
	STAIRS_TWIST_CLOCKWISE_UP_WEST = Shapes.or(PILLAR_DOWN_SOUTH, PILLAR_EAST_NORTH),
	STAIRS_TWIST_COUNTER_CLOCKWISE_UP_WEST = Shapes.or(PILLAR_DOWN_NORTH, PILLAR_EAST_SOUTH),
