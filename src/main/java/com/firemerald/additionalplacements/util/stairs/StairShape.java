...
public enum StairShape implements IStringSerializable {
	...
	OUTER_BOTTOM_RIGHT("outer_bottom_right", VoxelShapes::getRightOuterBottomFlatStairs, StairsShape.OUTER_LEFT, StairsShape.OUTER_RIGHT, true, false, false),
	...
	OUTER_BOTH_RIGHT("outer_both_right", VoxelShapes::getRightOuterStairs, StairsShape.OUTER_LEFT, StairsShape.OUTER_RIGHT, true, true, false),
