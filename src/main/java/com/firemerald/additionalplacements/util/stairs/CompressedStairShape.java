...
public enum CompressedStairShape implements IStringSerializable {
	...
	static {
		...
		NO_VERTICAL_CONNECTIONS = noVerticalConnections.toArray(new CompressedStairShape[noVerticalConnections.size()]);
		NO_MIXED_CONNECTIONS = noMixedConnections.toArray(new CompressedStairShape[noMixedConnections.size()]);
	}
